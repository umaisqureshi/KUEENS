...
class SpecialOfferMoreItems extends StatefulWidget {
  final String category;
  SpecialOfferMoreItems({this.category});
  @override
  _SpecialOfferMoreItemsState createState() => _SpecialOfferMoreItemsState();
}

class _SpecialOfferMoreItemsState extends State<SpecialOfferMoreItems> {
  @override
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: InkWell(
              onTap: () => Navigator.of(context).pushReplacementNamed('/home',arguments: widget.category),
              child: Icon(
                Icons.arrow_back,
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return AnimationConfiguration.staggeredGrid(
                                ...
                                child: ScaleAnimation(
                                    child: SpecialOfferCards(documentSnapshot: snapshot.data[index]),
                                ));
...
class SpecialOfferCards extends StatefulWidget {
  ...
  SpecialOfferCards({this.documentSnapshot});
  @override
