...
class PopularMoreItems extends StatefulWidget {
  final String category;

  PopularMoreItems({this.category});

  @override
  _PopularMoreItemsState createState() => _PopularMoreItemsState();
}

class _PopularMoreItemsState extends State<PopularMoreItems> {
  @override
