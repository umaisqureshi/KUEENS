...
class WeeklyMoreItems extends StatefulWidget {
  final String category;
  WeeklyMoreItems({this.category});
  @override
  _WeeklyMoreItemsState createState() => _WeeklyMoreItemsState();
}

class _WeeklyMoreItemsState extends State<WeeklyMoreItems> {
  @override
