...
class PopularMoreDrawerItems extends StatefulWidget {

  @override
  _PopularMoreDrawerItemsState createState() => _PopularMoreDrawerItemsState();
}

class _PopularMoreDrawerItemsState extends State<PopularMoreDrawerItems> {
  @override
  Widget build(BuildContext context) {
    bloc.fetchAllPopularPosts('all');
    return WillPopScope(
      onWillPop: () {
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(
                         widget.documentSnapshot.data()['images'][0],
                        ),
                        fit: BoxFit.cover,
                      ),
                    ),
